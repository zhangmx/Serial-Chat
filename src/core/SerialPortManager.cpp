...
SerialPortUser* SerialPortManager::getUser(const QString& portName)
{
    return m_users.value(portName, nullptr);
}
...
SerialPortUser* SerialPortManager::createUser(const SerialPortInfo& info)
{
    ...
    QObject::connect(user, &SerialPortUser::statusChanged,
                     this, &SerialPortManager::onUserStatusChanged);
    QObject::connect(user, &SerialPortUser::messageReceived,
                     this, &SerialPortManager::onUserMessageReceived);
...
bool SerialPortManager::hasFriend(const QString& portName) const
{
    return m_friendList.contains(portName);
}
...
void SerialPortManager::setRefreshInterval(int msec)
{
